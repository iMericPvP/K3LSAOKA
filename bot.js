...
                message.channel.send(`**للاستخدام
...
                message.channel.send(`**تم تغير الي__${msz}__**`)
...
                message.channel.send("**لا ينكنني معرفه هذه الروم**")
...
                 message.channel.send(`**تم تغير الي__${chn.name}__**`)
