...
if(args[0].startsWith("-")) return  message.channel.send('**!! I Cant Do it**');
            ...
            if (!defineduser) return message.channel.send(`**${prefix}trans @someone amount**`);
            if(defineduser.id === message.author.id) return message.channel.send("***!تعطي نفسك كريدت؟***")
...
var x2 = ['5587' ,' 9978' , '3785' , '7734' , '9864' , '7681' , '3758' , '7834' , '3489' , '1382' , '7389' , '8762' , '0889' , '0388' , '3316' , '0976' , '8603' , '1842' , '4565' , '9524' , '9524' , '0964' , '5930' , '5678' , '9567' , '6099' , '7058' , '0001' , '1324' , '9834' , '7668' , '0378' , '7055' , '9733' , '9876' , '9846' , '9685' , '8574' , '8975' , '9845' , '9862' , '0069' , '0807' , '0673' , '0813' , '1235' , '6879'];
        ...
        message.channel.send(` \`${args}\`** : عدد **  \n \`${x[x3]}\` ** : اكتب عدد **`).then(msg1=> { 
...
mentionned.send(` :credit_card: | تحويل \`\`\`تم تحويل ${args[0]} من الشخص ${message.author.username} ; (ID (${message.author.id})\`\`\``);
               message.channel.sendEmbed(embed)
        })
        })
