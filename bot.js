...
            ${prefix}setwlc <كتابه, صوره, امبد>

            ${prefix}setwlc msg <رساله>

            ${prefix}setwlc channal <اسم روم>**`)
...
                message.channel.send(`**للاستخدام: ${prefix}setwlc style <كتابه, صوره, امبد>**`)
...
                message.channel.send("يجب كتابه رساله")

            } else {

                message.channel.send(`**تم تغير رساله الترحيب الي __${msz}__**`)
...
                message.channel.send("يجب كتابه اسم روم")
...
                message.channel.send("**لا ينكنني رئيه الروم**")
...
                 message.channel.send(`**تم تغير الي روم __${chn.name}__**`)
...
client.on("ready", () => {
    var guild;
    while (!guild)
        guild = client.guilds.get("419553524339179530");
