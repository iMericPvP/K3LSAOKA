...
                message.channel.send(`**تم تغير الاستايل لي  ${sw[message.guild.id].styler}**`)
...
                message.channel.send(`**تم تغير الاستايل الي ${sw[message.guild.id].styler}**`)
...
                message.channel.send("**لا يوجد روم بهذه الاسم**")
...
                 message.channel.send(`**تم تغير روم الترحيب الي __${chn.name}__**`)
