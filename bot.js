...
client.on("message", function(message) {
   ...
   if(message.content.startsWith(prefix + "rps")) {
    ...
    let arrayRPS = ['**Puplic**','**Admin**','**Music**','Info','Music'];
...
function getValue(key, array) {
 ...
 client.on('message', message => {
    ...
    message.channel.send(`**اضغت علي رياكشن**`).then(msg => {
    msg.react('✅')
    .then(() => msg.react('❌'))
    .then(() =>msg.react('✅'))
    ...
    let reaction1 = msg.createReactionCollector(reaction1Filter, { time: 30000 });
    let reaction2 = msg.createReactionCollector(reaction2Filter, { time: 30000 });
	let reaction3 = msg.createReactionCollector(reaction3Filter, { time: 30000 });
    let reaction3 = msg.createReactionCollector(reaction4Filter, { time: 30000 });
	let reaction3 = msg.createReactionCollector(reaction5Filter, { time: 30000 });
 reaction1.on("collect", r => {
    message.channel.send(`**
...
var channel =member.guild.channels.find('name', args.join(' '));
if (!channel) return;
